#!/bin/bash
#### ---------------------------------------------------------------------------------------------//
#### This is a helper script to "4_make_HiChIP_clique_input.R".
...
# containing annotations for each anchor as enhancer or promoter as well as 2 .bedpe files of interactions for each condition 
...
# each condition (chr_A_start1_stop1,"enhancer/promoter"), and 2 .bedpe formatted files with filtered EE/PP/EP contacts for each condition
#### ---------------------------------------------------------------------------------------------//
...
# Generate clustertree input file for each condition
