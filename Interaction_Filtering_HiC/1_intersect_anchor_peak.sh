...
#### Overview: This script ultimately creates a .bed file containing the coordinates for 
# all accessible enhancer and promoter loop anchors from a HiC experiment (i.e. Ib-sensitive Rec-1), where accessible 
...
#
#### Final Output: .bed (8) file containing intervals of all size-adjusted, accessible, enhancer/promoter loop anchors (from Ib-sensitive Rec-1)
#### -------------------------------------------------------------------------------------------------------------------------//
...
# module load ucsc329 #optional
 
#### Set directory
WKDIR=/mnt/data1/brent/analysis/idea47_HiC_pro_REC1_IBR_ARIMA/S01_220105_REC1_parental_DMSO_ArimaHiC/quantify_bedpe_on_randomEP
cd ${WKDIR}

#### Inputs: Load file path containing hg19 chromosome intervals
GENOME=/mnt/data1/brent/analysis/GRCh37.75_ChromInfo.txt
...
ATAC=/mnt/data1/brent/analysis/idea47_HiC_pro_REC1_IBR_ARIMA/REC1_DMSO_IBR_RES_ATAC_merged_id.bed
ATAC_BASE=REC1_ATAC

#### Inputs: Load path to file containing all hg19 Transcription Start Sites (TSS) and name output file prefix
TSS=/mnt/data1/brent/analysis/170709_hg19_ensembl_ensg_longest_TSS.txt
...
ENH=/mnt/data1/brent/analysis/idea47_HiC_pro_REC1_IBR_ARIMA/REC1_DMSO_IBR_RES_H3K27ac_merged_id.bed
...
bedtools slop -i ${TSS} -b ${EXT} -g ${GENOME} > ${TSSEXT}
