...
#### Overview: This script takes a single .bedpe input file of accessible HiC loops and creates two datatables of loop anchors
...
####  Create two .bed4 files from .bedpe of (Rec-1 Ib-sensitive) HiC loops with for 'p' and 'q' anchors (respectively)
